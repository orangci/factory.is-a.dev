              ...
              return (
                <div key={type} className="space-y-4">
                  ...
                  <Alert className="mb-4 bg-accent/20 text-body-fg border-accent">
                    ...
                    <AlertDescription>
                      A valid reason must be provided in order for NS record requests to be approved. Read <u><a href="https://docs.is-a.dev/faq/#who-can-use-ns-records">this page</a></u> to see who is eligible to use NS records.
                    </AlertDescription>
                  </Alert>
